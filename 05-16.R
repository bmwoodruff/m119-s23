...
f5 <- function(x,a1=6.23e-3,a2=5.06e-5){ (a0 + a1*x)*exp(-a2*x) }
...
find_you <- function(x){ f4(x,a0=100,a1=-1.81e-4,a2=0.83) - 80 }
uniroot(find_you, c(0, 800000))$root

uniroot(function(x){f4(x,a0=100,a1=-1.81e-4,a2=0.83)-80}, c(0, 800000))$root


find_you <- function(x){f3(x)-90}
uniroot(find_you, c(0, 800000))$root
